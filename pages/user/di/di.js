var commonCityData = require('../../../utils/citys.js')
//获取应用实例
var app = getApp()
Page({
  data: {
  ...
  bindSave: function (e) {
    ...
    wx.getStorage({
        ...
        success: function(res) {
            wx.request({
                url: 'https://yj.beaconway.cn/address/',
                data: {
                    ...
                    zipcode: code, // 邮编
                    // isDefault: 'true'
                    type: "1", // 是否设为默认地址 1默认，0不默认
                    is_delete: 0, // 是否删除 0未删除，1删除
                    create_time: Date.parse(new Date()) // 创建时间
                },
                header: {
